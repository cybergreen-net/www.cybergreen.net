...
**Open DNS**: The Domain Name System (DNS) is pervasive. For enterprises, it is their digital identity as well as a critical component of their security architecture. Since DNS runs on the UDP protocol, it can be used for amplification attacks. <a target="_blank" href="http://stats.cybergreen.net/risk/opendns/">Read more &raquo;</a>

<img style="width:60px" src="{{site.media}}icon22.jpg"/>
**Open NTP**: Computers and network devices have a perversely strong need to have good agreement about what constitutes the current time. Most computers stay synchronized using Network Time Protocol (NTP). Just like DNS, NTP is a UDP-based service, and shares the same weaknesses that DNS does. <a target="_blank" href="http://stats.cybergreen.net/risk/openntp/">Read more &raquo;</a>
...
<table cellspacing="10px" cellpadding="10px" style="border-spacing: 10px">
    <tbody>
        <tr>
            ...
            <td style="padding-right: 10px" width="200" height="100" border="1px" align="center">
